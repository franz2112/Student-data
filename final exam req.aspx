<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="final exam req.aspx.vb" Inherits="Student_data.final_exam_req" %>
...
<head runat="server">
    <title></title>
    <link rel="stylesheet" href="finalexamcss.css" />
</head>
<body>
        ...
        <div class="main-furniture">
            <div class="display-design">
                ...
                <div class="buttonsii-furniture-container">
                   ...
                   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="buttons-furniture" Width="294px" AutoPostBack="True" OnSelectedIndexChanged="OnSelectedIndexChange" DataSourceID="SqlDataSource1" DataTextField="ProductDescription" DataValueField="ProductDescription" Height="30px"></asp:DropDownList>
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:solmayorConnectionString %>" ProviderName="<%$ ConnectionStrings:solmayorConnectionString.ProviderName %>" SelectCommand="getProductDescription" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </div>   
            </div>
            <div class="grid-design">
                ...
                <!--Total<asp:TextBox ID="totalIDbox" runat="server"></asp:TextBox> -->
             </div>    
        </div>                     
    </form>
</body>
